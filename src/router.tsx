    ...
    // ── 应用主体（AppShell 布局包裹所有子路由） ────────────────────────────────
    {
        ...
        children: [
            ...
            },
            {
                ...
                lazy: async () => {
                    const component = await import('@/pages/legal/LegalPage');
            ...
            },
            {
                ...
                loader: requireAuth,
                lazy: async () => {
                    const component = await import('@/pages/Account/AccountPage');
                    return {
                        Component: component.default
                    }
                }
            },
            {
                ...
                loader: requireAuth,
                lazy: async () => {
                    const component = await import('@/pages/Account/TokenPage');
                    return {
                        Component: component.default
                    }
                }
            },
            {
                ...
                loader: requireAuth,
                lazy: async () => {
                    const component = await import('@/pages/Account/SettingPage');
                    return {
                        Component: component.default
                    }
                }
            ...
            // ── 兜底：所有未匹配路径 → 404 页面 ─────────────────────────────
            {
                path: '*',
                lazy: async () => {
                    const component = await import('@/pages/Error/NotFoundPage');
                    return {
                        Component: component.default
                    }
                }
