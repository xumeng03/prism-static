...
// 文档元数据：驱动 LegalPage 左侧文档切换列表；顺序即展示顺序
// 名称加 LEGAL_ 前缀避免与其它模块可能存在的 "docs" 常量冲突
export const LEGAL_DOCS: { key: LegalDoc; zh: string; en: string }[] = [
...
// 四份法律文档的完整正文：以 doc key 为索引，每份含标题、更新时间和章节数组
// 章节 body 元素形如 [中文段落, English paragraph]，由 useTranslation 按当前语言拾取
